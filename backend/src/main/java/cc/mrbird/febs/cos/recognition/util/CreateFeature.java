...
public class CreateFeature {
    ...
    //构造函数,为成员变量赋值
    public CreateFeature(String requestUrl, String APPID, String apiSecret, String apiKey) {
    ...
    //提供给主函数调用的方法
    public static JSONObject doCreateFeature(String requestUrl, String APPID, String apiSecret, String apiKey, Map<String,Object> requestParams) throws Exception {
        CreateFeature createFeature = new CreateFeature(requestUrl, APPID, apiSecret, apiKey);
        String resp = createFeature.doRequest(requestParams);
    ...
    private String buildParam(Map<String,Object> requestParams) throws IOException {
        String param = "{" +
                ...
                //这里填上所需要的featureId
                "            \"featureId\": \""+requestParams.get("featureId")+"\"," +
                //这里填上所需要的featureInfo
                "            \"featureInfo\": \""+requestParams.get("featureInfo")+"_"+System.currentTimeMillis()+"\"," +
                "            \"createFeatureRes\": {" +
                "                \"encoding\": \"utf8\"," +
                "                \"compress\": \"raw\"," +
                "                \"format\": \"json\"" +
